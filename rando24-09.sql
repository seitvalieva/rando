...
-- Dumping data for table rando.image: ~7 rows (approximately)
...
INSERT INTO `rando` (`id_rando`, `title`, `subtitle`, `dateRando`, `timeRando`, `durationDays`, `durationHours`, `distance`, `postDate`, `description`, `image`, `departure`, `destination`, `user_id`) VALUES
	...
	(23, 'RandoTest14', 'Introduction RandoTest14', '2024-09-24', '15:32:00', 1, 1, 0.1, '2024-09-23 14:34:01', 'Description RandoTest14', NULL, 'Strasbourg', 'Molsheim', 29),
	(24, 'RandoTest15', 'Introduction RandoTest15', '2024-09-24', '13:44:00', 1, 1, 0.1, '2024-09-23 14:46:29', 'Description RandoTest15', NULL, 'Strasbourg', 'Molsheim', 29),
	(25, 'RandoTest16 with 2 pictures', 'Introduction RandoTest16 ', '2024-09-24', '13:46:00', 1, 1, 0.1, '2024-09-23 14:48:05', 'Description RandoTest16 ', NULL, 'Strasbourg', 'Molsheim', 29),
	(26, 'RandoTest17', 'Introduction  RandoTest17', '2024-09-25', '09:37:00', 1, 1, 0.1, '2024-09-24 08:39:15', 'Description RandoTest17', NULL, 'Strasbourg', 'Molsheim', 29),
	(27, 'RandoTest27', 'Introduction RandoTest27', '2024-09-25', '15:01:00', 1, 1, 0.1, '2024-09-24 14:01:06', 'Description RandoTest27', NULL, 'Strasbourg', 'Molsheim', 29),
	(28, 'RandoTest28', 'Introduction RandoTest28', '2024-09-25', '17:15:00', 1, 1, 0.1, '2024-09-24 16:16:09', 'Description RandoTest28', 'sun-background-1727187369.png', 'Strasbourg', 'Molsheim', 29);
